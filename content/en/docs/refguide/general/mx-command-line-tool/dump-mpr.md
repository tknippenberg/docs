...
| `--exclude-protected-modules` | | Exclude protected modules from the JSON export. Deprecated: IP protection and protected modules are deprecated and will be removed in a future major version. |
