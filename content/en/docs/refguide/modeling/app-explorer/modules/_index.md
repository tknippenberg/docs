...
* [Add-on modules](/refguide/module-settings/#add-on-module) (deprecated)
* [Solution modules](/refguide/module-settings/#solution-module) (deprecated)

## Common

| Document type | Typical elements | Description |
| --- | --- | --- |
| [Pages](/refguide/pages/) | [Data view](/refguide/data-view/), [data grid](/refguide/data-grid/), [table](/refguide/table/), [text box](/refguide/text-box/) | Forms are used to create a user interface for the end-user. They are composed of components that are called [widgets](/appstore/widgets/). |
...
| [Mapping Documents](/refguide/mapping-documents/) | A domain-to-XML mapping defines a translation from domain model objects to XML objects. |
...
| [Published OData/GraphQL Services](/refguide/published-odata-services/) | Persistable entities can be exposed in an OData service so  they can be imported by third-party applications such as Excel. |
| [Published Web Services](/refguide/published-web-services/) | A microflow can be published as a web service operation so it can be called by third-party applications. |
